...
const actions = [
  {
    ...
    inputs: [
      ...
      { name: 'rate', label: 'Rate (0.1-10)', type: 'number', value: 1.0 },
      { name: 'pitch', label: 'Pitch (0.5-2)', type: 'number', value: 1.0 },
      { name: 'volume', label: 'Volume (0-1)', type: 'number', value: 1.0 },
    ],
    run: async (values) => {
    ...
    inputs: [
      {
        ...
        type: 'textarea',
        value: 'This will be saved to a file.',
      },
      { name: 'filename', label: 'Filename', type: 'text', value: 'synthesis.wav' },
      { name: 'language', label: 'Language (optional)', type: 'text', value: 'en-US' },
    ],
    run: async (values) => {
    ...
    inputs: [
      {
        ...
        options: [
          ...
          { value: 'playAndRecord', label: 'Play and Record' },
        ],
      },
    ],
    run: async (values) => {
